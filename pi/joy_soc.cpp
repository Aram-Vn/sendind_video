...
int main()
{
    ...
    // Update the IP address to your Raspberry Pi
    inet_pton(AF_INET, "192.168.27.20", &server_addr.sin_addr);
    ...
    while (true)
    {
        ...
        {
            // Handle other status cases if needed (like LIBEVDEV_READ_STATUS_SYNC)
            continue;
        }
    }
